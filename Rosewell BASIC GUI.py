...
def copyright():
    ...
    try:
        clrprint('© Blake Gouthro and JinHo Mo |' , 'Rosewell', 'B', 'A', 'S', 'I', 'C', '| V2.3 | Rosewell Software | 2021 - ' + str(today.year) + ' ©', clr=['blue', 'white', 'red', 'yellow', 'green', 'blue', 'purple', 'blue', 'blue'])
    except:
        print(rose)
...
''')
    #Speech to Text
    elif cmd in ['sr','SR','sR','Sr','STT','stt','st','ST','St','sT','STt','sTT','StT','Speech To Text','speech to text','Speech To text','speech To Text','Speech to Text']:
...
colormenu.add_command(label="Light Blue", command=lb)
...
def copyright():
    ...
    try:
        clrprint('© Blake Gouthro and JinHo Mo |' , 'Rosewell', 'B', 'A', 'S', 'I', 'C', '| V2.4 | Rosewell Software | 2021 - ' + str(today.year) + ' ©', clr=['blue', 'white', 'red', 'yellow', 'green', 'blue', 'purple', 'blue', 'blue'])
    except:
        print(rose)
