...
rose = "© Blake Gouthro and JinHo Mo | Rosewell BASIC | V2.0.3 | Rosewell Software | 2021 - " + str(today.year) + " ©"
load = ''
...
def copyright():
    ...
    try:
        clrprint('© Blake Gouthro and JinHo Mo |' , 'Rosewell', 'B', 'A', 'S', 'I', 'C', '| V2.0 | Rosewell Software | 2021 - ' + str(today.year) + ' ©', clr=['blue', 'white', 'red', 'yellow', 'green', 'blue', 'purple', 'blue', 'blue'])
    except:
        print(rose)
