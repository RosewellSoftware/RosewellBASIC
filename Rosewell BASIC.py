...
def poke(word):
    ...
    try:
        ...
        print(e) 
rose = "© Blake Gouthro and JinHo Mo | Rosewell BASIC | V1.5.4 | Rosewell Software | 2021 - " + str(today.year) + " ©"
...
''')
  ...
  #Clock/Calendar
      ...
      if line in ['Date', 'date', 'D', 'd', 'Calender', 'calendar', 'C', 'c', 'Time', 'time', 'T', 't', 'Clock', 'clock', 'CLOCK', 'DATE', 'TIME']:
        print("Todays Date:")
        print(today)
...
[4] Main Menu''')
        ...
        continue
  #All chr
      if line in ['All Chr', 'all chr', 'All chr', 'all Chr', 'ALL CHR']:
          atsciiprint()
          print(' ')
          print('Ready')
          continue
  ...
  #Directory
      if line == "Dir" or line == "dir" or line == "Directory" or line == "directory" oe line == 'DIR' or line == 'DIRECTORY':
