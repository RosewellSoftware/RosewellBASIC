...
def copyright():
    ...
    try:
        clrprint('© Blake Gouthro and JinHo Mo |' , 'Rosewell', 'B', 'A', 'S', 'I', 'C', '| V2.0.3 | Rosewell Software | 2021 - ' + str(today.year) + ' ©', clr=['blue', 'white', 'red', 'yellow', 'green', 'blue', 'purple', 'blue', 'blue'])
    except:
        print(rose)
...
[7] Play Without Loop''')
  ...
  #Text To Speech
      if line in ['Speech','speech','SPEECH','Text To Speech','text to speech','TEXT TO SPEECH','Text to speech','text To speech','text to Speech',' Text To speech','text To Speech','Text to Speech','TTS','tts','Tts','tTs','ttS','TTs','tTS','TtS']:
          ...
          print("Type 'Quit' or 'Exit' to return to the Ready Prompt")
          while True:
