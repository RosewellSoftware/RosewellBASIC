...
rose = "© Blake Gouthro and JinHo Mo | Rosewell BASIC | V1.5.7 | Rosewell Software | 2021 - " + str(today.year) + " ©"

def copyright():
    
    
    try:
        clrprint('© Blake Gouthro and JinHo Mo |' , 'Rosewell', 'B', 'A', 'S', 'I', 'C', '| V1.5.7 | Rosewell Software | 2021 - ' + str(today.year) + ' ©', clr=['blue', 'white', 'red', 'yellow', 'green', 'blue', 'purple', 'blue', 'blue'])
    except:
        print(rose)
